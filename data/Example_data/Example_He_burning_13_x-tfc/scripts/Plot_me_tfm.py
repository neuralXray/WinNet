...
xpos_dic = {'he4':1e2,'c12':1e-11,'o16':2e-12,'ne20':1e-12,\
            'mg24':1e-12,'si28':1e-12,'s32':1e-12,'ar36':4e-4,'ca40':2e-11,'ti44':1e-10,\
            'cr48':1e-9,'fe52':1e-8,'ni56':5e-7}
...
ax_energy.text(5e-12,2e24,r'$\epsilon$',color='saddlebrown')
ax_energy.set_yscale('log')
ax_energy.set_ylabel(r'Energy [erg g$^{-1}$ s$^{-1}$]')
ax_energy.set_ylim(1e11,10**(25 + 0.3))
...
ax.set_ylim(1e-21, 10**(0 + 0.3/2*3))
ax.grid()
